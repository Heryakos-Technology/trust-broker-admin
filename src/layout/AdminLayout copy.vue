...
import DashboardIcon from "/blokerimage.png";
...
<template>
  <div class="bg-[#0B0F31] ">
    <div class=" w-full overflow-y pt-10 px-4 relative text-base">
      <!-- Mobile Sidebar -->
      <div
        ...
        <div class="px-8 mt-16">
          ...
          <ul class="ml-8 text-xl mt-8 space-y-8">
            ...
            <RouterLink
              ...
              class="flex cursor-pointer hover:font-bold transition-all ease-linear duration-200 gap-x-2 items-center"
            >
              <img :src="RatingIcon" alt="" class="size-6" />customers
            </RouterLink>
            <!-- :to="{ name: 'AdminUsers' }" -->
            <RouterLink
          ...
          <li
              class="flex cursor-pointer mt-6 hover:font-bold transition-all ease-linear duration-200 gap-x-2 items-center"
            >
              <img :src="DashboardIcon" alt="" class="size-6" />
              Dashboard
            </li>
          <ul class="ml-8 text-xl mt-8 space-y-8">
            ...
            <RouterLink
              ...
              class="flex cursor-pointer hover:font-bold transition-all ease-linear duration-200 gap-x-2 items-center"
            >
              <img :src="RatingIcon" alt="" class="size-6" />sign in 
            </RouterLink>
            <!-- :to="{ name: 'AdminUsers' }" -->
            <RouterLink
              ...
              class="flex cursor-pointer hover:font-bold transition-all ease-linear duration-200 gap-x-2 items-center"
            >
              <img :src="userIcons" alt="" class="size-6" />sign up
            </RouterLink>
            <RouterLink
              
              class="flex cursor-pointer hover:font-bold transition-all ease-linear duration-200 gap-x-2 items-center"
            >
              <img :src="userIcons" alt="" class="size-6" />Reset password
            </RouterLink>
            <!-- :to="{ name: 'AdminCategories' }" -->
